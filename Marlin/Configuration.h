...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 40.52
  #define DEFAULT_bedKi 7.73
  #define DEFAULT_bedKd 141.62
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -13, -0.65 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP 10.0  // (mm) Move nozzle up before moving between corners
